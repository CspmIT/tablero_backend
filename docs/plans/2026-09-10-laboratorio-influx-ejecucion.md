...
- Se respeta el diseño de Juan: roles
...
- **Servidor MQTT opcional** (pedido de Agustín, 10/09): la pantalla vieja no lo
  pedía y el borrado no lo usa; queda solo como referencia en el historial.
